...
| 0988 | [Smallest String Starting From Leaf](https://leetcode.com/problems/smallest-string-starting-from-leaf) | 🟡 `Medium` | [C++](Trees/0988-smallest-string-starting-from-leaf/0988-smallest-string-starting-from-leaf.cpp) | DFS (Depth-First Search) + Backtracking + String Comparison in $O(N * N)$ time |
...
| 0513 | [Find Bottom Left Tree Value](https://leetcode.com/problems/find-bottom-left-tree-value/) | 🟡 `Medium` | [C++](Trees/0513-find-bottom-left-tree-value/0513-find-bottom-left-tree-value.cpp) | BFS (Level Order Traversal) in $O(n)$ time |
...
| 1367 | [Linked List in Binary Tree](https://leetcode.com/problems/linked-list-in-binary-tree) | 🟡 `Medium` | [C++](Trees/1367-linked-list-in-binary-tree/1367-linked-list-in-binary-tree.cpp) | DFS + Recursive Matching in $O(N * M)$ time |
...
| 1530 | [Number of Good Leaf Nodes Pairs](https://leetcode.com/problems/number-of-good-leaf-nodes-pairs) | 🟡 `Medium` | [C++](Trees/1530-number-of-good-leaf-nodes-pairs/1530-number-of-good-leaf-nodes-pairs.cpp) | Postorder DFS + Tree Dynamic Programming (Distance Tracking) in $O(N × D²)$ time |
...
| 2641 | [Cousins in Binary Tree II](https://leetcode.com/problems/cousins-in-binary-tree-ii) | 🟡 `Medium` | [C++](Trees/2641-cousins-in-binary-tree-ii/2641-cousins-in-binary-tree-ii.cpp) | Level-order BFS queue traversal processing tree nodes by depth |
...
| 1367 | [Linked List in Binary Tree](https://leetcode.com/problems/linked-list-in-binary-tree) | 🟡 `Medium` | [Problem Notes](Trees/1367-linked-list-in-binary-tree/) | [C++](Trees/1367-linked-list-in-binary-tree/1367-linked-list-in-binary-tree.cpp) |
