...
| 1631 | [Path With Minimum Effort](https://leetcode.com/problems/path-with-minimum-effort) | 🟡 `Medium` | [🔍 Binary Search](BinarySearch/) | [Problem](BinarySearch/1631-path-with-minimum-effort/) | [Approach 1](BinarySearch/1631-path-with-minimum-effort/1631-path-with-minimum-effort.cpp) · [Approach 2](BinarySearch/1631-path-with-minimum-effort/1631-path-with-minimum-effort-approach-2.cpp) |
...
| 1631 | [Path With Minimum Effort](https://leetcode.com/problems/path-with-minimum-effort) | 🟡 `Medium` | [Problem Notes](BinarySearch/1631-path-with-minimum-effort/) | [Approach 1](BinarySearch/1631-path-with-minimum-effort/1631-path-with-minimum-effort.cpp) · [Approach 2](BinarySearch/1631-path-with-minimum-effort/1631-path-with-minimum-effort-approach-2.cpp) |
